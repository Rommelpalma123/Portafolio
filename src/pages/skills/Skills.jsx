...
import { galeria } from '@/helpers/utils';
  ...
  return (
    <div className='mt-4'>
      <div className='container-skills'>
        <p>
          En esta seccion podras encontrar algunas de las tecnologias que uso con mas frecuancia en
          el desarollo habitual de mis aplicaciones web
        </p>
      </div>
        ...
        <div className='wrapper'>
          ...
          <div className='carousel'>
            {imagenes.map((imagen, index) => {
              return <img draggable='false' key={index} src={imagen} alt={`image ${index}`} />;
            })}
          </div>
          <i id='right'>
            <IoMdArrowDropright />
