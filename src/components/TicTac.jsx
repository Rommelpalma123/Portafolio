...
import { turns } from '../helpers/constans.js';
    ...
    <div className='mt-4'>
      <div className='info-game'>
        <h4 className='text-light'>
          En esta seccion podras encontrar unos de mis trabajos como desarollador, este trabajo es
          el famoso juego de tic tac o mas conocido como tres en raya, este proyecto esta realizado
          con react
        </h4>
        <h4 className='text-light'>
          El objetivo de este pequeño juego es practicar logica de programacion para pasar el juego
          de la hoja comun a un entorno web y poder ser jugado por cualquier persona
        </h4>
      </div>
      ...
      <div className='info-game'>
        <h4 className='text-light'>
          Aqui encontraras otro trabajo realizado por mi persona, este trabajo consiste en consumir
          una api, la cual es api pokemon donde se trae una lista de todos los pokemons existentes y
          se muestra por pantalla
        </h4>
        <h4 className='text-light'>
          Una vez traida la informacion, se puede seleccionar cualquier tipo de pokemon donde se
          mostrara mas a detalle sobre dicho pokemon y adicionalmente las evoluciones que el pokemon
          tiene
        </h4>
      </div>
      <div className='contenedor-imagen'>
        <a
          ...
          <img src={pokemon} className='imagen-pokemon' alt='pagina de pokemon' />
        </a>
      </div>
      <Footer />
    </div>
